...
const Barra_NavOpcion = ({nombre, rutaMA,rutaMA1,rutaMA2, rutaDFDxN, rutaDD}) => {
        ...
        <div className='absolute bg-[#151515] hidden group-hover:block p-10 rounded-xl '>
              <span className=" ">
                  ...
                  <div className='flex flex-row pl-6 py-2 group'>
                    ...
                    <h1 className='text-[16px] text-[#ffffff] inria-serif-bold px-2 hover:text-[#4871AF] cursor-pointer' onClick={activarMA2}>Diagrama de contexto</h1>
                  </div>
                  ...
                  <div className='flex flex-row pl-6 py-2 group'>
                    ...
                    <h1 className='text-[16px] text-[#ffffff] inria-serif-bold px-2 hover:text-[#4871AF] cursor-pointer' onClick={activarMA3}>Lista de Acontecimientos</h1>
                  </div>
